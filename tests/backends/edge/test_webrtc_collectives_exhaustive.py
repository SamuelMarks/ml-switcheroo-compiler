"""Exhaustive tests for WebRTC distributed collective operations."""
...
@pytest.mark.asyncio
async def test_webrtc_collectives_edge_branches() -> None:
    """Test edge branches including None partners, endianness conversion, and dispatch fallthroughs."""
