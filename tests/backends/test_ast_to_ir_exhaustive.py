"""Exhaustive unit tests for ast_to_ir, ir_to_ast, and mapping_loader to achieve 100% coverage."""
...
def test_mapping_loader_exhaustive():
    """Verify all branches, edge cases, and error paths in mapping_loader."""
...
def test_ir_to_ast_exhaustive():
    """Verify all branches and emission patterns in ir_to_ast."""
...
def test_ast_to_ir_exhaustive():
    """Verify all AST visitor branches (binary ops, control flow, self params, subscripts)."""
...
def test_ast_to_ir_additional_edges() -> None:
    """Test edge branches in ast_to_ir for 100% coverage."""
