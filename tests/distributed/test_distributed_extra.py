...
def test_distributed_eager() -> object:
    """Function docstring."""
...
def test_all_reduce_ast() -> object:
    """Function docstring."""
    with ConfigContext(eager_mode=False, backend="numpy"):
        global_tracing_state.start_tracing("test")
        t1 = asarray(np.array([1, 2, 3]))
...
def test_all_to_all_ast() -> object:
    """Function docstring."""
    with ConfigContext(eager_mode=False, backend="numpy"):
        global_tracing_state.start_tracing("test")
        t1 = asarray(np.array([1, 2, 3]))
