...
def test_einsum_infer_shape_coverage():
    ...
    with pytest.raises(ValueError, match="Equation has 2 operands, but 1 shapes were provided"):
    ...
    # 7. Shape too small for subscripts
    ...
    # 13. Shape length mismatch (no ellipsis)
    ...
    with pytest.raises(ValueError, match="Output subscript l not in input"):
