"""Exhaustive unit tests to achieve 100% branch and line coverage on all backend profilers."""
...
def test_numpy_profiler_exhaustive():
    """Verify all branches and non-darwin OS memory tracking in NumpyProfiler."""
...
def test_jax_profiler_exhaustive():
...
def test_pytorch_profiler_exhaustive():
...
def test_mlx_profiler_exhaustive():
    """Verify all branches and Apple Silicon Metal peak memory metrics in MLXProfiler."""
...
def test_cupy_profiler_exhaustive():
    """Verify full execution simulation and memory peak tracking in CupyProfiler."""
