...
def promote_types(dtype1: DType, dtype2: DType) -> DType:
    ...
    if dtype1 not in _rank or dtype2 not in _rank:
        raise DTypePromotionError(f"Cannot promote types: {dtype1} and {dtype2}")
    ...
    if is_complex1 or is_complex2:
        if dtype1 == DType.Complex128 or dtype2 == DType.Complex128:
    ...
    if is_float1 or is_float2:
        ...
        if dtype1 == DType.Float32 or dtype2 == DType.Float32:
