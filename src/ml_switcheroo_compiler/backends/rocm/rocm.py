...
class RocmCodeGenerator(BaseGenerator):
    ...
    def __init__(self, graph: IRGraph, delegates: Optional[list[object]] = None) -> None:
        ...
        yaml_path: object = os.path.join(os.path.dirname(__file__), "rocm_templates.yaml")
    ...
    def generate(self) -> str:
        ...
        """
        hip: object = ["// ROCm HIP Generated by ml-switcheroo-compiler"]
        ...
        for _node_id, node in getattr(self.graph, "nodes", {}).items():
            ...
            tpl: object = self.config.templates.get(op_type.lower())
            if tpl:
                out_name: object = f"d_out_{node_idx}"
