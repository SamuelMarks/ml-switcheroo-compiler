...
class MLXVisionVisitorMixin:
    ...
    def visit_ResizeBicubic(self, node: object, input_vars: list[str], **kwargs: object) -> str:
        ...
        return (
            f"mlx_resize({input_vars[0]}, {size}, 'bicubic', {align_corners})"  # pragma: no cover
        )
    ...
    def visit_ResizeLanczos3(self, node: object, input_vars: list[str], **kwargs: object) -> str:
        ...
        align_corners = node.attributes.get("align_corners", False)  # pragma: no cover
        return (
            f"mlx_resize({input_vars[0]}, {size}, 'lanczos3', {align_corners})"  # pragma: no cover
        )
...
class MLXAudioVisitorMixin:
    ...
    def visit_Istft(self, node: object, input_vars: list[str], **kwargs: object) -> str:
        ...
        return f"mlx_istft({input_vars[0]}, {frame_length}, {frame_step}, {fft_len_str}, '{window}', {center})"  # pragma: no cover
    ...
    def visit_Mfcc(self, node: object, input_vars: list[str], **kwargs: object) -> str:
        ...
        return f"mlx_mfcc({input_vars[0]}, {sample_rate}, {num_mel_bins}, {lower_edge_hertz}, {upper_edge_hertz}, {num_mfccs})"  # pragma: no cover
