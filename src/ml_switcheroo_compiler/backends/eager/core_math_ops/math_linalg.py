...
def _cholesky_ex(backend_module: object, *args: object, **kwargs: object) -> object:
    ...
    Returns:
            tuple[int, ...]: Result.
    """
    chol: object = _cholesky(backend_module, *args, **kwargs)
    if hasattr(backend_module, "zeros"):
        info: object = backend_module.zeros((), dtype=getattr(backend_module, "int32", int))
    else:
        info: object = 0
    return (chol, info)
...
def _np_schur(backend_module: object, *args: object, **kwargs: object) -> object:
    ...
    Returns:
            tuple[int, ...]: Result.
    """
    func: object = getattr(backend_module, "schur", getattr(backend_module, "schur", None))
    if func is not None:
...
def _np_svd(backend_module: object, *args: object, **kwargs: object) -> object:
    ...
    Returns:
            tuple[int, ...]: Result.
    """
    func: object = getattr(backend_module, "svd", getattr(backend_module, "svd", None))
    if func is not None:
        return func(*args, **kwargs)
    import numpy as np
...
def _np_svdvals(backend_module: object, *args: object, **kwargs: object) -> object:
    ...
    Returns:
            tuple[int, ...]: Result.
    """
    func: object = getattr(backend_module, "svdvals", getattr(backend_module, "svdvals", None))
    if func is not None:
        return func(*args, **kwargs)
    import numpy as np
...
def _np_tensorinv(backend_module: object, *args: object, **kwargs: object) -> object:
    ...
    Returns:
            tuple[int, ...]: Result.
    """
    func: object = getattr(backend_module, "tensorinv", getattr(backend_module, "tensorinv", None))
    if func is not None:
        return func(*args, **kwargs)
    import numpy as np
...
def _np_triinv(backend_module: object, *args: object, **kwargs: object) -> object:
    ...
    Returns:
            tuple[int, ...]: Result.
    """
    func: object = getattr(backend_module, "triinv", getattr(backend_module, "triinv", None))
    if func is not None:
        return func(*args, **kwargs)
    import numpy as np
...
def _np_uniqueinverse(backend_module: object, *args: object, **kwargs: object) -> object:
    ...
    Returns:
            tuple[int, ...]: Result.
    """
    func: object = getattr(backend_module, "uniqueinverse", getattr(backend_module, "uniqueinverse", None))
    if func is not None:
        return func(*args, **kwargs)
    import numpy as np
...
def _np_vander(backend_module: object, *args: object, **kwargs: object) -> object:
    ...
    Returns:
            tuple[int, ...]: Result.
    """
    func: object = getattr(backend_module, "vander", getattr(backend_module, "vander", None))
    if func is not None:
        return func(*args, **kwargs)
    import numpy as np
...
def _np_vectornorm(backend_module: object, *args: object, **kwargs: object) -> object:
    ...
    Returns:
            tuple[int, ...]: Result.
    """
    func: object = getattr(backend_module, "vectornorm", getattr(backend_module, "vectornorm", None))
    if func is not None:
        return func(*args, **kwargs)
    import numpy as np
