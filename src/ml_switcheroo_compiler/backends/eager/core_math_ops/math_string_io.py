...
def _np_decodeimage(backend_module: Any, *args: Any, **kwargs: Any) -> Any:
...
@global_eager_registry.register("Fromfile")
def _np_fromfile(backend_module: Any, *args: Any, **kwargs: Any) -> Any:
...
@global_eager_registry.register("Fromstring")
def _np_fromstring(backend_module: Any, *args: Any, **kwargs: Any) -> Any:
...
def _np_parsetensor(backend_module: Any, *args: Any, **kwargs: Any) -> Any:
...
def _np_stringlower(backend_module: Any, *args: Any, **kwargs: Any) -> Any:
...
def _np_stringsplit(backend_module: Any, *args: Any, **kwargs: Any) -> Any:
...
def _np_stringtohash(backend_module: Any, *args: Any, **kwargs: Any) -> Any:
...
def _np_stringtonumber(backend_module: Any, *args: Any, **kwargs: Any) -> Any:
...
def _np_stringupper(backend_module: Any, *args: Any, **kwargs: Any) -> Any:
...
def _np_textvectorization(backend_module: Any, *args: Any, **kwargs: Any) -> Any:
