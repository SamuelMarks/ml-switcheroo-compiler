...
def _flip_horizontal(img: Any, rng: Any) -> Any:
    ...
    Args:
        img (Any): The input image array to flip.
        rng (Any): The random number generator instance.
...
def _compute_rotation_matrix(np_mod: Any, angle: float, W: int, H: int) -> tuple[float, float]:
    """Calculate the 2D affine matrix coefficients for a given rotation angle.

    Args:
        np_mod (Any): The numpy-like module for math operations.
...
def _generate_coordinate_grid(np_mod: Any, H: int, W: int) -> tuple[Any, Any]:
    ...
    Args:
        np_mod (Any): The numpy-like module for array creation.
...
def _apply_affine_transform(y_grid: Any, x_grid: Any, params: AffineTransformParams) -> tuple[Any, Any]:
    ...
    Args:
        y_grid (Any): The Y-coordinate grid to transform.
        x_grid (Any): The X-coordinate grid to transform.
...
def _interpolate_pixels(np_mod: Any, imgs: Any, new_y: Any, new_x: Any, config: RotationConfig) -> Any:
    ...
    Args:
        np_mod (Any): The numpy-like module for array manipulation.
        imgs (Any): The batch of source images.
        new_y (Any): The Y-coordinates to sample from.
        new_x (Any): The X-coordinates to sample from.
...
def _compute_rotation_grid(np_mod: Any, H: int, W: int, rng: Any, factor: float) -> tuple[Any, Any]:
    ...
    Args:
        np_mod (Any): The numpy-like module for array operations.
...
def random_rotation_eager(backend_module: Any, images: Any, config: RotationConfig) -> Any:
    ...
    Args:
        backend_module (Any): The backend module to use for array operations.
        images (Any): The input tensor of images to rotate.
...
def _crop_and_pad_single(np_mod: Any, img: Any, rng: Any, shape_info: tuple[int, int, int, int]) -> Any:
    ...
    Args:
        np_mod (Any): The numpy-like module for array operations.
        img (Any): The single image array to crop.
        rng (Any): The random number generator instance.
...
def _compute_random_crop(np_mod: Any, imgs: Any, config: RandomCropConfig | None = None) -> Any:
    ...
    Args:
        np_mod (Any): The numpy-like module for array operations.
        imgs (Any): The batch of images to crop.
...
def random_crop_eager(backend_module: Any, images: Any, size: tuple[int, int], seed: Any = None) -> Any:
...
def random_perspective_eager(backend_module: Any, images: Any, factor: float | tuple[float, float], **kwargs: Any) -> Any:
    ...
    Args:
        backend_module (Any): The backend module to use for array operations.
        images (Any): The input tensor of images to transform.
        factor (float | tuple[float, float]): The severity factor of the perspective distortion.
        **kwargs (Any): Additional transformation configuration options.
...
def _blur_displacement(np_mod: Any, d: Any, s: float) -> Any:
    ...
    Args:
        np_mod (Any): The numpy-like module for array operations.
        d (Any): The raw displacement field array.
...
def _get_elastic_factor(rng: Any, f: Any) -> float:
    ...
    Args:
        rng (Any): The random number generator instance.
        f (Any): A scalar factor or a tuple representing a uniform range.
...
def random_elastic_transform_eager(
    ...
    **kwargs: Any,
    ...
    Args:
        backend_module (Any): The backend module to use for array operations.
        images (Any): The input tensor of images to distort.
        ...
        **kwargs (Any): Additional configuration parameters like interpolation or padding mode.
...
def _get_shear_factor(rng: Any, factor: Any) -> float:
    ...
    Args:
        rng (Any): The random number generator instance.
        factor (Any): A scalar defining the symmetric range or a tuple defining min/max shear.
...
def random_zoom_eager(
    ...
    **kwargs: Any,
    ...
    Args:
        backend_module (Any): The backend module to use for array operations.
        images (Any): The input tensor of images to zoom.
        ...
        **kwargs (Any): Additional configuration like interpolation or fill mode.
...
def random_translation_eager(
    ...
    **kwargs: Any,
    ...
    Args:
        backend_module (Any): The backend module to use for array operations.
        images (Any): The input tensor of images to shift.
        ...
        **kwargs (Any): Additional configuration parameters like interpolation mode.
...
def random_shear_eager(
    ...
    **kwargs: Any,
    ...
    Args:
        backend_module (Any): The backend module to use for array operations.
        images (Any): The input tensor of images to shear.
        ...
        **kwargs (Any): Additional configuration variables, e.g., interpolation.
