...
def _run_scipy_istft(stft_np_flat: object, win: object, frame_params: tuple[int, int, int], center: bool) -> int:
    """Evaluate _run_scipy_istft operation.

    Args:
        stft_np_flat: The stft_np_flat parameter.
...
def _apply_istft_batch(np_mod: Any, stft_np: object, win: object, config: STFTConfig, **kwargs: Any) -> int:
    """Evaluate _apply_istft_batch operation.

    Args:
        np_mod: The np_mod parameter.
        stft_np: The stft_np parameter.
        win: The win parameter.
...
def istft_eager(backend_module: Any, stft_tensor: Any, config: STFTConfig, center: bool = True) -> int:
    ...
    Args:
        ...
        stft_tensor: The stft_tensor parameter.
        config (STFTConfig): The config parameter.
        center (bool): The center parameter.
...
def _compute_filterbank_weights(np_mod: Any, num_spectrogram_bins: int, num_mel_bins: int, bin_freqs: object, hz_pts: object) -> int:
    ...
    Args:
        ...
        bin_freqs: The bin_freqs parameter.
        hz_pts: The hz_pts parameter.
...
def mel_filterbank_eager(backend_module: Any, _: object, config: MelFilterbankConfig) -> int:
...
def _apply_dct(log_mel_spec: object, num_mfccs: int) -> int:
    """Apply Discrete Cosine Transform to log-mel spectrogram.

    Args:
        log_mel_spec: The log_mel_spec parameter.
...
def _power_to_db(np_mod: Any, mel_spec: object) -> int:
    """Convert power spectrogram to decibel scale.

    Args:
        np_mod: The np_mod parameter.
        mel_spec: The mel_spec parameter.
...
def _mfcc_eager_tf(backend_module: Any, spectrogram: object, config: MFCCConfig) -> int:
    """Evaluate _mfcc_eager_tf operation.

    Args:
        backend_module: The backend_module parameter.
        spectrogram: The spectrogram parameter.
...
def _convert_to_np(np_mod: Any, x: object, is_torch: bool, is_mlx: bool) -> int:
...
def _to_backend_tensor(name: str, mfccs: object, spectrogram: object, np_mod: Any) -> int:
    """Convert numpy array back to backend tensor.

    Args:
        name (str): The name parameter.
        mfccs: The mfccs parameter.
        spectrogram: The spectrogram parameter.
        np_mod: The np_mod parameter.
...
def mfcc_eager(backend_module: Any, spectrogram: object, config: MFCCConfig) -> int:
...
def _apply_stft_batch(np_mod: Any, audio_np: object, win: object, config: STFTConfig) -> int:
    """Evaluate _apply_stft_batch operation.

    Args:
        np_mod: The np_mod parameter.
        audio_np: The audio_np parameter.
        win: The win parameter.
        config (STFTConfig): The config parameter.
...
def _to_backend_tensor_complex(name: str, out: object, np_mod: Any, backend_module: Any, **kwargs: Any) -> int:
...
def stft_eager(backend_module: Any, input_tensor: Any, config: STFTConfig) -> int:
    ...
    Args:
        backend_module: The backend_module parameter.
        input_tensor: The input_tensor parameter.
        config (STFTConfig): The config parameter.
