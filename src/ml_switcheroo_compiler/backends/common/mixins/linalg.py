...
class LinearAlgebraASTVisitor(CommonASTVisitor):
    ...
    def visit_CholeskyVjp(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
    ...
    def visit_LuVjp(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
    ...
    def visit_BandPart(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
    ...
    def visit_BandedTriangularSolve(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
    ...
    def visit_GatherMm(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
    ...
    def visit_SegmentedMm(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
    ...
    def visit_BlockMaskedMm(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
    ...
    def visit_Quantize(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
    ...
    def visit_QuantizedMatmul(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
    ...
    def visit_GatherQMM(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
    ...
    def visit_QrVjp(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
    ...
    def visit_SvdVjp(self, node: IRNode, input_vars: list[str], **kwargs: Any) -> str:
