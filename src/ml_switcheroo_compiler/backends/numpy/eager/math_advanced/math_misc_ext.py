...
def _np_truncate_div(backend_module, *args, **kwargs):
...
def _np_truncate_mod(backend_module, *args, **kwargs):
...
def _np_betainc(backend_module, *args, **kwargs):
...
def _np_trapz(backend_module, *args, **kwargs):
...
def _np_uint(backend_module, *args, **kwargs):
...
def _np_uint8(backend_module, *args, **kwargs):
...
def _np_unravelindex(backend_module, *args, **kwargs):
...
def _np_unwrap(backend_module, *args, **kwargs):
...
def _np_vectorize(backend_module, *args, **kwargs):
...
def _np_average(backend_module, *args, **kwargs):
...
def _np_atleast_1d(backend_module, *args, **kwargs):
...
def _np_atleast_2d(backend_module, *args, **kwargs):
...
def _np_atleast_3d(backend_module, *args, **kwargs):
...
def _np_apply_over_axes(backend_module, *args, **kwargs):
...
def _np_corrcoef(backend_module, *args, **kwargs):
...
def _np_cov(backend_module, *args, **kwargs):
...
def _np_array_repr_(backend_module, *args, **kwargs):
...
def _np_array_str_(backend_module, *args, **kwargs):
...
def _np_diff_(backend_module, *args, **kwargs):
...
def _np_digitize_(backend_module, *args, **kwargs):
...
def _np_ediff1d_(backend_module, *args, **kwargs):
...
def _np_einsum_path_(backend_module, *args, **kwargs):
...
def _np_fabs_(backend_module, *args, **kwargs):
...
def _np_interp_(backend_module, *args, **kwargs):
...
def _np_iterable_(backend_module, *args, **kwargs):
...
def _np_ix__(backend_module, *args, **kwargs):
...
def _np_kron_(backend_module, *args, **kwargs):
...
def _np_load_(backend_module, *args, **kwargs):
...
def _np_modf_(backend_module, *args, **kwargs):
...
def _np_ravel_multi_index_(backend_module, *args, **kwargs):
...
def _np_trapz_(backend_module, *args, **kwargs):
...
def _np_callable(backend_module, *args, **kwargs):
    """Implement Callable.
...
def _np_debuginfs(backend_module, *args, **kwargs):
    """Implement DebugInfs.
...
def _np_debugnans(backend_module, *args, **kwargs):
    """Implement DebugNans.
...
def _build_dot_general_einsum_str(lhs_ndim: int, rhs_ndim: int, dimension_numbers) -> str:
...
def _np_dotgeneral(backend_module, *args, **kwargs):
...
def _np_raggeddot(backend_module, *args, **kwargs):
    """Implement RaggedDot.
...
def _np_tensor(backend_module, *args, **kwargs):
    """Implement Tensor.
...
def _np_rem(backend_module, *args, **kwargs):
...
def _np_serialize_tensor(backend_module, *args, **kwargs):
...
def _np_descriptive(backend_module, *args, **kwargs):
...
def _np_key(backend_module, *args, **kwargs):
...
def _get_np_arg(arg, i: int) -> np.ndarray | None:
    """Get numpy arg.
...
def _np_one_hot(backend_module, *args, **kwargs):
...
def _np_serialize_tensor_camel(backend_module, *args, **kwargs):
...
@numpy_eager_registry.register("rem")
def _np_rem_2(backend_module, *args, **kwargs):
    """Evaluate _np_rem operation.
...
@numpy_eager_registry.register("descriptive")
def _np_descriptive_2(backend_module, *args, **kwargs):
    """Evaluate _np_descriptive operation.
...
@numpy_eager_registry.register("Rem")
def _np_rem_3(backend_module, *args, **kwargs):
    """_np_rem_3 function.
