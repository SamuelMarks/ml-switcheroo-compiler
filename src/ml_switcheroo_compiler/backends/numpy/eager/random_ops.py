...
def _np_normal(backend_module, shape, **kwargs):
...
def _np_uniform(backend_module, shape, **kwargs):
...
def _np_stateless_split(backend_module, seed, **kwargs):
...
def _np_lookup(backend_module, table, keys, **kwargs):
