...
def _np_fft(backend_module, *args, **kwargs):
...
def _np_irfft(backend_module, *args, **kwargs):
...
def _np_fft2(backend_module, *args, **kwargs):
...
def _np_fftfreq(backend_module, *args, **kwargs):
...
def _np_ihfft(backend_module, *args, **kwargs):
