...
def _np_randomuniform(backend_module, *args, **kwargs):
...
def _np_randomchoice(backend_module, *args, **kwargs):
...
def _np_randomshuffle(backend_module, *args, **kwargs):
...
def _np_dirichlet(backend_module, *args, **kwargs):
