...
def resize_bilinear(
    ...
    w_factor = size[1] / images.shape[2]  # pragma: no cover
    return scipy.ndimage.zoom(images, (1, h_factor, w_factor, 1), order=1)  # pragma: no cover
...
def resize_nearest(
    ...
    Returns:
        The resized images.
    """
    h_factor = size[0] / images.shape[1]  # pragma: no cover
    w_factor = size[1] / images.shape[2]  # pragma: no cover
    return scipy.ndimage.zoom(images, (1, h_factor, w_factor, 1), order=0)  # pragma: no cover
...
def resize_bicubic(
    ...
    h_factor = size[0] / images.shape[1]  # pragma: no cover
    w_factor = size[1] / images.shape[2]  # pragma: no cover
    return scipy.ndimage.zoom(images, (1, h_factor, w_factor, 1), order=3)  # pragma: no cover
