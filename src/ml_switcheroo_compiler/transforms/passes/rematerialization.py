...
def _estimate_compute(node: IRNode, rules) -> float:
...
def _find_target_nodes(nodes: list[IRNode], consumers: dict[str, list[str]], node_indices: dict[str, int], rules) -> list[IRNode]:
