...
def _extract_arr_bytes(arr) -> bytes:
...
def _get_data_bytes(tensor) -> bytes:
...
def _tensor_to_npy_bytes(tensor) -> bytes:
...
def get_npz_bytes(weights) -> bytes:
    """Get npz bytes.
