...
class DotGeneral(OpDef):
    ...
    def _compute_out_shape(self, lhs_shape: tuple[Any, ...], rhs_shape: tuple[Any, ...], dimension_numbers: tuple[Any, ...]) -> tuple[Any, ...]:
...
def _compute_pdot_shape(lhs_shape: tuple[Any, ...], rhs_shape: tuple[Any, ...]) -> tuple[Any, ...]:
