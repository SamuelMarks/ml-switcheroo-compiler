...
def scaled_dot_product_attention(q: Tensor, k: Tensor, v: Tensor, scale_factor: Tensor) -> object:
...
class ScaledDotProductAttention(OpDef):
    ...
    def infer_shape(self, q: object, k: object, v: object, scale_factor: object, **kwargs: object) -> object:
        """Infer shape.
