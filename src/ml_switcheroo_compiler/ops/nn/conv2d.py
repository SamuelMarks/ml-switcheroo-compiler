...
def conv2d(lhs: Tensor, rhs: Tensor, config_obj: typing.Optional[object] = None) -> Tensor:
    """2D Convolution.
    ...
    if config_obj is None:  # pragma: no branch
        config_obj = _build_conv_config({}, ((0, 3, 1, 2), (3, 2, 0, 1), (0, 3, 1, 2)))
...
def depthwise_conv2d(lhs: Tensor, rhs: Tensor, config_obj: typing.Optional[object] = None) -> Tensor:
    ...
    rhs_reshaped, config_obj = _prepare_depthwise_conv(lhs, rhs, 2, dimension_numbers, config_obj)
...
def separable_conv2d(
    ...
    **kwargs: object,
    ...
    """
    dw_out = depthwise_conv2d(lhs, depthwise_filter, strides=strides, padding=padding)
