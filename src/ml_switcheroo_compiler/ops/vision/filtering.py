...
def gaussian_blur(images: Tensor, config_obj=None, **kwargs):
...
def sharpen(images: Tensor, factor: float = 1.0):
    """Sharpen images.
...
def random_sharpness(images: Tensor, factor: float | tuple[float, float], **kwargs):
